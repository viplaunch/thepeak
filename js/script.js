...
$('#contact-btn').click(function(e) {
	e.preventDefault();
	var unitType = [];
	$.each($("input[name='unitType']:checked"), function(){
		unitType.push($(this).val());
	});

	$.ajax({
		type: "POST",
		url: "//formspree.io/jadewu@viplaunch.sg",
		data: {
			_subject: $('#contact-form').find('input[name="_subject"]').val(),
			...
			country: $('#contact-form').find('input[name="country"]').val(),
			favorite: unitType,
